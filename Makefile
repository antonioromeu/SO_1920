...
tecnicofs-mutex: lib/bst.o lib/hash.o fs.o main-mutex.o
	$(LD) $(CFLAGS) $(LDFLAGS) -DMUTEX -o tecnicofs-mutex lib/bst.o lib/hash.o fs.o main-mutex.o

tecnicofs-rwlock: lib/bst.o lib/hash.o fs.o main-rwlock.o
	$(LD) $(CFLAGS) $(LDFLAGS) -DRWLOCK -o tecnicofs-rwlock lib/bst.o lib/hash.o fs.o main-rwlock.o
